          ...
          <div className="grid sm:grid-cols-8 gap-3 py-8 md:py-12 border-t border-gray-200">
            ...
            <div className="sm:col-span-6 md:col-span-3 lg:col-span-3">
              <div className="justify-center items-center space-y-4 sm:flex sm:space-y-0 sm:space-x-4">
                <a href="https://apps.apple.com/us/app/sharetogo-carpooling/id6746420222"
                  ...
                  <div className="text-left text-white">
                    <div className="-mt-1 font-sans text-sm font-semibold">Disponible en la App Store</div>
                  </div>
                </a>
                <a href="#"
                  ...
                  <div className="text-left text-white">
                    <div className="-mt-1 font-sans text-sm font-semibold">Disponible en la Play Store</div>
                  </div>
                </a>
              </div>
            </div>
